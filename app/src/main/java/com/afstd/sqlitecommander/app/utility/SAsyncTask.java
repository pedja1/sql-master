 ...
 */
public abstract class SAsyncTask<Params, Progress, Result>
{
    ...
    public SAsyncTask()
    {
        ...
        mFuture = new FutureTask<Result>(mWorker)
        {
            ...
            protected void done()
            {
                ...
                {
                    if(SettingsManager.DEBUG())android.util.Log.w(LOG_TAG, e);
                }
     ...
     */
    public SAsyncTask<Params, Progress, Result> execute(Params... params)
    {
     ...
     *                               {@link Status#RUNNING} or {@link Status#FINISHED}.
     */
    final SAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                Params... params)
    {
    ...
    {
        final SAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(SAsyncTask task, Data... data)
        {
            mTask = task;
            mData = data;
        }
