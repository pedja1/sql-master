...
package com.afstd.sqlitecommander.app.view;
 ...
 */
public class SpannableListPreference extends DialogPreference
{
    ...
    public SpannableListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
         ...
         */
        a = context.obtainStyledAttributes(attrs, R.styleable.SpannableListPreference, defStyleAttr, defStyleRes);
        mSummary = a.getString(R.styleable.SpannableListPreference_android_summary);
        a.recycle();
    }
        ...
        builder.setSingleChoiceItems(mEntries, mClickedDialogEntryIndex,
                new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int which)
                    {
                         ...
                         */
                        SpannableListPreference.this.onClick(dialog, DialogInterface.BUTTON_POSITIVE);
                        dialog.dismiss();
                    }
                });
