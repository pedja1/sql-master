 ...
 */
public class FragmentPostgreSQL extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        mAdapter.setOnItemClickListener(new RVArrayAdapter.OnItemClickListener()
        {
            ...
            {
                PostgreSQLCMDActivity.start(getActivity(), ((DatabaseEntry) item).id);
            }
        });
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.fabAdd:
                AddSQLDatabaseActivity.start(this, AddPostgreSQLDatabase.class, null, REQUEST_CODE_ADD_DATABASE);
                break;
        }
    }
    ...
    {
        private WeakReference<FragmentPostgreSQL> reference;

        ATLoadDatabases(FragmentPostgreSQL adapter)
        {
